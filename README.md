...
[![CI](https://github.com/Independent-Streamer-Reviews/iptv-uptime-checker/actions/workflows/test.yml/badge.svg)](https://github.com/Independent-Streamer-Reviews/iptv-uptime-checker/actions)
...
See the docstring at the top of [`iptv_uptime_checker.py`](./iptv_uptime_checker.py) —
